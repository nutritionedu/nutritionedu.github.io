        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        questionHTML.append('<h5>' + formatQuestion + '</h5>');
            ...
            completeQuiz: function(options) {
                ...
                if (plugin.config.disableRanking) {
                    ...
                    var levels    = [
                                        quizValues.info.level1, // 76-100%
                                        quizValues.info.level2, // 51-75%
                                        quizValues.info.level3, // 26-50%
                                        quizValues.info.level4, // 1-25%
                                        quizValues.info.level5  // 0%
                                    ],
            ...
            calculateLevel: function(correctAnswers) {
                ...
                if (plugin.method.inRange(0, 0.24, percent)) {
                    level = 4;
                } else if (plugin.method.inRange(0.25, 0.50, percent)) {
                    level = 3;
                } else if (plugin.method.inRange(0.51, 0.75, percent)) {
                    level = 2;
                } else if (plugin.method.inRange(0.76, 0.99, percent)) {
                    level = 1;
