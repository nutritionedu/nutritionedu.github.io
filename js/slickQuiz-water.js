        ...
        plugin.method = {
            ...
            completeQuiz: function(options) {
                ...
                if (plugin.config.disableRanking) {
                    ...
                    var levels    = [
                                        quizValues.info.level1, // 68-100%
                                        quizValues.info.level2, // 34-67%
                                        quizValues.info.level3, // 1-33%
            ...
            calculateLevel: function(correctAnswers) {
                ...
                if (plugin.method.inRange(0, 0.32, percent)) {
                    level = 3;
                } else if (plugin.method.inRange(0.33, 0.66, percent)) {
                    level = 2;
                } else if (plugin.method.inRange(0.67, 0.99, percent)) {
                    level = 1;
